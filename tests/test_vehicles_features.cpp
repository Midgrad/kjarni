...
TEST_F(VehiclesFeaturesTest, testAddFeatures)
{
    ...
    features.addFeature(vehicle::generic.id, features::instruments, "GenericInstruments.qml");
    ...
    EXPECT_EQ(features.feature(vehicle::generic.id, features::instruments), "GenericInstruments.qml");
...
TEST_F(VehiclesFeaturesTest, testRemoveFeatures)
{
    ...
    features.removeFeature(vehicle::generic.id, features::instruments);

    EXPECT_NE(features.feature(vehicle::generic.id, features::instruments), "GenericInstruments.qml");
